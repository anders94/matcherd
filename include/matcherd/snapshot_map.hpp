...
namespace cbdc {
    ...
    class snapshot_map {
      public:
        ...
        auto find(const K& key) const -> typename map_type::const_iterator {
        ...
        auto end() const -> typename map_type::const_iterator {
            return m_map.end();
        }

        auto begin() const -> typename map_type::const_iterator {
            return m_map.begin();
        }
