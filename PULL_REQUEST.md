...
*Make sure tests pass on all of the [relevant CI workflows](https://github.com/anders94/matcherd/actions).*

### Pull Request Readiness Checklist

See details at [CONTRIBUTING.md](https://github.com/anders94/matcherd/blob/master/CONTRIBUTING.md).
